...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] imageFileID = {R.drawable.kakao01,R.drawable.kakao02,R.drawable.kakao03,R.drawable.kakao04,R.drawable.kakao05,R.drawable.kakao06,R.drawable.kakao07,R.drawable.kakao08,R.drawable.kakao09};
        // 참조변수에 View 객체 연결
        ...
        IV.setImageResource(imageFileID[max_index]);
        TV.setText(imageNames[max_index]);
